...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-6" data-genuitec-path="/red_wine/WebRoot/Home/knowledge.jsp">
<div class="red_wine_box" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-6" data-genuitec-path="/red_wine/WebRoot/Home/knowledge.jsp">
    ...
    <div class="news_list_box">
        <div class="news_list_box_left">
            <img src="${pageContext.request.contextPath }/Home/image/knowledge_photo.png" />
        </div>
        <div class="knowledge_title">
            <img src="${pageContext.request.contextPath }/Home/image/knowledge_sign.png" />
        </div>
        <div class="news_list_box_right">
            <ul style="width: 100%;height: 390px;overflow: auto;">
            <c:choose>
					<c:when test="${not empty result.list}">
						<c:forEach var="result" items="${result.list}">
							<li><a href="${pageContext.request.contextPath }/servlet/HomeServlet?method=knowledge_detail&id=${result.id}" class="list_a">>>  ${result.title}     <span>${result.date}</span></a></li>
						</c:forEach>
					</c:when>
            ...
            <ul class="list_page">
                <li><a href="${pageContext.request.contextPath }/servlet/HomeServlet?currentPage=${result.PageDate.currentPage-1}&method=knowledge" class="list_a"> 上一页 </a> </li>
                <li class="page_num"> ${result.PageDate.currentPage}/${result.PageDate.totalPage} </li>
                <li><a href="${pageContext.request.contextPath }/servlet/HomeServlet?currentPage=${result.PageDate.currentPage+1}&method=knowledge" class="list_a"> 下一页>> </a> </li>
            </ul>
        </div>
    </div>
</div>
