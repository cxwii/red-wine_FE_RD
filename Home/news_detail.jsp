...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-9" data-genuitec-path="/red_wine/WebRoot/Home/news_detail.jsp">
<div class="red_wine_box" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-9" data-genuitec-path="/red_wine/WebRoot/Home/news_detail.jsp">
    ...
    <div class="news_detail_title">
        <h3>${result.title}</h3>   <!-- 公司资讯标题 -->
        <span>发布作者：${result.author}</span>
        <span>&nbsp;&nbsp;&nbsp;&nbsp;发布时间：${result.date}</span>
    </div>
    <div class="news_detail_content">${result.content}</div>  <!-- 公司资讯内容 -->
    <div class="news_page_box">
        <ul>
            <a href="${pageContext.request.contextPath }/servlet/HomeServlet?method=news"><li> << 返回列表</li></a>
        </ul>
    </div>
