...
Source Database       : red_wine

Target Server Type    : MYSQL
Target Server Version : 80020
File Encoding         : 65001

Date: 2021-06-26 17:35:58
*/
...
INSERT INTO `administrators` VALUES ('2', '1234', '1234');
...
-- ----------------------------
INSERT INTO `commodity_class` VALUES ('1', '张裕');
INSERT INTO `commodity_class` VALUES ('2', '长城');
INSERT INTO `commodity_class` VALUES ('3', '菲埃妮古堡');
INSERT INTO `commodity_class` VALUES ('4', '拉菲庄园');
...
CREATE TABLE `company_profile` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='公司简介';

-- ----------------------------
-- Records of company_profile
-- ----------------------------
INSERT INTO `company_profile` VALUES ('8', 'dwqdqw');
...
CREATE TABLE `recruit` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='招贤纳士';

-- ----------------------------
-- Records of recruit
-- ----------------------------
INSERT INTO `recruit` VALUES ('3', '红酒Sales', '无责底薪6K+带薪培训+公司自有客户资源+晋升机会多+福利多+公司氛围好+五险一金', '大专以上学历but，颜值高于一切，你懂得！\r\n只要你具备以上条件，恭喜你，你是我们想要的人。');
INSERT INTO `recruit` VALUES ('4', '调酒师学徒', '协助调酒师处理日常事务，了解(洋酒、红酒、鸡尾酒)调制方法', '18至28周岁，身体健康，踏实肯干。有无经验均可，能适应晚班。');
INSERT INTO `recruit` VALUES ('5', '高薪销售', '热爱销售，具备一定的销售能力,勇于证明自己，对销售行业有一定的兴趣与认识；', '依托公司优质客户资源通过公司外呼系统/微信群，通过电话/网络的方式让客户了解我们的产品并掌握客户需求；为客户提供快速、准确、专业的销售及咨询服务。\r\n');
