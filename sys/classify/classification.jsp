...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-18" data-genuitec-path="/red_wine/WebRoot/sys/classify/classification.jsp">
	<!-- 页面标题 -->
	<div id="TitleArea" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-18" data-genuitec-path="/red_wine/WebRoot/sys/classify/classification.jsp">
	...
	<!-- 过滤条件 -->
	<div id="QueryArea">
		<form action="${pageContext.request.contextPath }/servlet/ClassificationServlet?id=${result.id}&method=search" method="post">
						...
						<c:when test="${not empty result.list}">
							...
							<c:forEach var="result" items="${result.list}">
								<tr class="TableDetail1">
									...
									<td>${result.title}</td>
									<td>
										<a href="${pageContext.request.contextPath }/servlet/ClassificationServlet?id=${result.id}&method=Jumpup" class="FunctionButton">更新</a> 
										<a href="${pageContext.request.contextPath }/servlet/ClassificationServlet?id=${result.id}&method=delete" class="FunctionButton">删除</a>
									</td>
								</tr>
							</c:forEach>
