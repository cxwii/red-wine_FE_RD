...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-21" data-genuitec-path="/red_wine/WebRoot/sys/goods/goods.jsp">
<!-- 页面标题 -->
<div id="TitleArea" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-21" data-genuitec-path="/red_wine/WebRoot/sys/goods/goods.jsp">
	<div id="TitleArea_Head"></div>
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="${pageContext.request.contextPath }/sys/style/images/title_arrow.gif"/> 产品列表
		</div>
    </div>
