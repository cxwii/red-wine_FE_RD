...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-22" data-genuitec-path="/red_wine/WebRoot/sys/goods/update.jsp">
	<!-- 页面标题 -->
	<div id="TitleArea" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-22" data-genuitec-path="/red_wine/WebRoot/sys/goods/update.jsp">
						...
						<table cellpadding="0" cellspacing="0" class="mainForm">
							...
							<tr>
								...
								<td><img
									...
									<input type="file" name="photo" id="upload"/> *</td>
							</tr>
						</table>
					</div>
				</div>
