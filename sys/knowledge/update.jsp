...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-29" data-genuitec-path="/red_wine/WebRoot/sys/knowledge/update.jsp">

<!-- 页面标题 -->
<div id="TitleArea" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-29" data-genuitec-path="/red_wine/WebRoot/sys/knowledge/update.jsp">
